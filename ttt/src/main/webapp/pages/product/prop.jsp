...
<script type="text/javascript" src="js/product/prop.js"></script>
<title>商品管理</title>
</head>
<body>
...
<div class="page-container">
	...
	<a href="javascript:;" onclick="prop_add('添加商品','prop/add','800','800')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a></span>  </div>
