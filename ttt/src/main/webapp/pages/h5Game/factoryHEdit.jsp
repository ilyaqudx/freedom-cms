...
<script type="text/javascript" src="js/h5Game/factoryHEdit.js"></script>
<title>未来工厂</title>
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>多任务：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" min="0" value="${stage.tasks }" placeholder="" id="tasks" name="tasks">
		</div>
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>重复几率：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" min="0" value="${stage.repeatRate }" placeholder="" id="repeatRate" name="repeatRate">
		</div>
	</div>
	<div class="row cl">
