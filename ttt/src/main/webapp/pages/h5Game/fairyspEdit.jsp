...
<script type="text/javascript" src="js/h5Game/fairyspEdit.js"></script>
<title>花仙子</title>
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" min="0" value="${stage.difficulty }" placeholder="" id="difficulty" name="difficulty">
		</div>
	</div>
	<div class="row cl">
