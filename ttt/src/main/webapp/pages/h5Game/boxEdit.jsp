...
<script type="text/javascript" src="js/h5Game/boxEdit.js"></script>
<title>侦探专家</title>
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" min="0" value="${stage.eachtime }" placeholder="" id="eachtime" name="eachtime">
		</div>
	</div>
	<div class="row cl">
