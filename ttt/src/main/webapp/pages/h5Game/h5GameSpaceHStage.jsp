...
<script type="text/javascript" src="js/h5Game/spaceH.js"></script>
...
<div class="page-container">
	<div class="text-c"> 
		<input type="text" name="stageId" id="stageId" placeholder=" 关卡" style="width:250px" class="input-text">
...
<iframe id="uploadCallback" name="uploadCallback" style="visibility: hidden"></iframe></body>
</html>