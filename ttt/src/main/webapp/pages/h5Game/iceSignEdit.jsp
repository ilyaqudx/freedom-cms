...
<script type="text/javascript" src="js/h5Game/iceSignEdit.js"></script>
<title>踩冰块</title>
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>符号数量：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" min="0" value="${stage.signNum }" placeholder="" id="signNum" name="signNum">
		</div>
	</div>
	<div class="row cl">
