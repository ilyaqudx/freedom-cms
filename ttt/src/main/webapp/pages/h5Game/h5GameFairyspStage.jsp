...
<script type="text/javascript" src="js/h5Game/fairysp.js"></script>
<link rel="stylesheet" type="text/css" href="static/h-ui/css/H-ui.min.css" />
<title>游戏列表- 夏日池塘-词语</title>
</head>
<body>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
     ...
     <form target="uploadCallback" action="config/upload" enctype="multipart/form-data" method="post" id="autoSubmit">
	  ...
	  <span style="float: right;margin-right: 100px;font-size: 14px;">
       <a onclick="fairyDiff('查看','diff/list','800','500')" href="javascript:;"> 查看关联表</a>
     </span>
	   </div>
	<div class="mt-20">
