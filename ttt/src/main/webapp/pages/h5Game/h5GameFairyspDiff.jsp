...
<script type="text/javascript" src="js/h5Game/fairyspDiff.js"></script>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
     ...
     <form target="uploadCallback" action="diff/upload" enctype="multipart/form-data" method="post" id="autoSubmit">
