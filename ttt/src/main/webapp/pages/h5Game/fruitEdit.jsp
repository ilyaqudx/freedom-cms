...
<script type="text/javascript" src="js/h5Game/fruitEdit.js"></script>
<title>水果商店</title>
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" min="0" value="${stage.orderNum }" placeholder="" id="orderNum" name="orderNum">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>停留最小值：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="number" class="input-text" min="0" value="${stage.minStop }" placeholder="" id="minStop" name="minStop">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>停留最大值：</label>
		<div class="formControls col-xs-8 col-sm-9">
