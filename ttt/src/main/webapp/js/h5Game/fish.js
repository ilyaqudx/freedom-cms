					...
					{// 得到表格
						...
						"columns" : [// 具体的列
								...
								{// 第4列，试卷
									...
									name : "oneOperationNum",
									data : "oneOperationNum",
									title : "第一阶段操作个体数",
									orderable : false
								}, {// 第7
									name : "twoOriginNum",
									...
									name : "twoOperationNum",
									data : "twoOperationNum",
									title : "第二阶段操作个体数",
									orderable : false
								}, {// 第10
									name : "minMemoryTime",
						...
						"aoColumnDefs" : [
								...
								},
								{
									targets : 15,
									render : function(data, type, row, meta) {
										return '<a title="编辑" href="javascript:;" onclick="stage_edit(\'关卡编辑\',\'fish/edit?id='
												+ row.id
