					...
					{// 得到表格
						...
						"columns" : [// 具体的列
								...
								{// 第4列，试卷
									...
									name : "reactionTimeMin",
									data : "reactionTimeMin",
									title : "反应时间最小",
									orderable : false
								}, {// 第8
									name : "reactionTimeMax",
									data : "reactionTimeMax",
									title : "反应时间最大",
									orderable : false
								}, {// 第9
									name : "intervalTime",
						...
						"aoColumnDefs" : [
								...
								},
								{
									targets : 12,
									render : function(data, type, row, meta) {
										return '<a title="编辑" href="javascript:;" onclick="stage_edit(\'关卡编辑\',\'gamestage/edit?id='
