	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${users}" var="u">
			<tr class="text-c">
				...
				<td>${u.id}</td>
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">${u.name}</u></td>
				<td>男</td>
				<td>${u.phone}</td>
				<td>${u.identityCode}</td>
				<td class="text-l">${u.address}</td>
				<td><fmt:formatDate value="${u.createTime}"  pattern="yyyy-MM-dd" type="both"/></td>
