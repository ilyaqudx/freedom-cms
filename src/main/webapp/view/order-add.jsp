...
<div class="left-side sticky-left-side" tabindex="5000" style="overflow: hidden; outline: none;">
    ...
    <div class="left-side-inner">
        <ul class="nav nav-pills nav-stacked custom-nav">
            <li class="menu-list">
                <a href="http://osd.greenleafgroup.cn/member/withdraw/add.aspx#"><i class="lnr lnr-envelope"></i><span>新闻公告</span></a>
            ...
            <li class="menu-list">
                <a href="http://osd.greenleafgroup.cn/member/withdraw/add.aspx#"><i class="lnr lnr-user"></i>
                    <span>专卖店管理</span></a>
                <ul class="sub-menu-list">
            ...
            <li class="menu-list">
                <a href="http://osd.greenleafgroup.cn/member/withdraw/add.aspx#">
            ...
            <li class="menu-list"><a href="http://osd.greenleafgroup.cn/member/withdraw/add.aspx#">
        ...
        <div class="user-panel-top">
            <div class="profile_details_left">
                <ul class="nofitications-dropdown">
                    ...
                    <li class="dropdown">
                        <a href="http://osd.greenleafgroup.cn/member/withdraw/add.aspx#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                             <span>最新公告</span>
                        </a>
            ...
            <div class="profile_details">
                <div class="profile_img">
                    ...
                    <div class="user-name">
                        <p><b id="top1_p_name">姚兰</b><span id="top1_p_level">会员</span></p>
                    </div>
                    <div class="clearfix"></div>
                </div>
