...
<input type="hidden" name="__RefreshHiddenField" id="__RefreshHiddenField" value="113110.31434">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="">
</div>

<div>

	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwKXjc2/CwKd+7qdDgLf5KzLC0NDJRLYyPWBBO5FKtQ5ZfouKBvJ">
</div>
        <section>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group has-warning">
                                            ...
                                            <div class="col-sm-6">
                                                <input name="payPassword" type="password" id="payPassword" class="form-control" placeholder="请在此输入二级密码">
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="submit" onclick="return toSubmit()" name="btnCheck" value="二级密码验证" id="btnCheck" class="btn btn-warning">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
	...
	function toSubmit(){
		...
		$.ajax({
			type:'POST',
			url:"/verifyPayPwd?payPassword="+payPassword,
			dataType:'json',
