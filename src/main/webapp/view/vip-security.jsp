...
<div class="left-side sticky-left-side" tabindex="5000" style="overflow: hidden; outline: none;">
    ...
    <div class="left-side-inner">
        <ul class="nav nav-pills nav-stacked custom-nav">
            <li class="menu-list">
                <a href="http://osd.greenleafgroup.cn/member/updpwd.aspx#"><i class="lnr lnr-envelope"></i><span>新闻公告</span></a>
            ...
            <li class="menu-list">
                <a href="http://osd.greenleafgroup.cn/member/updpwd.aspx#"><i class="lnr lnr-user"></i>
                    <span>专卖店管理</span></a>
                <ul class="sub-menu-list">
            ...
            <li class="menu-list">
                <a href="http://osd.greenleafgroup.cn/member/updpwd.aspx#">
            ...
            <li class="menu-list"><a href="http://osd.greenleafgroup.cn/member/updpwd.aspx#">
